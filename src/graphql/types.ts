...
export enum CompanyNoteSortFields {
  CreatedAt = 'createdAt',
  Id = 'id',
  UpdatedAt = 'updatedAt'
}
...
export enum ContactNoteSortFields {
  CreatedAt = 'createdAt',
  Id = 'id',
  UpdatedAt = 'updatedAt'
}
...
export enum DealStageSortFields {
  CreatedAt = 'createdAt',
  Id = 'id',
  Title = 'title',
  UpdatedAt = 'updatedAt'
...
export enum TaskStageSortFields {
  CreatedAt = 'createdAt',
  Id = 'id',
  Title = 'title',
  UpdatedAt = 'updatedAt'
...
export type MeCheckQuery = { me: { name: string } };

export type MeIdentityQueryVariables = Exact<{ [key: string]: never; }>;


export type MeIdentityQuery = { me: { id: string, name: string, email: string, phone?: string | null, jobTitle?: string | null, timezone?: string | null, avatarUrl?: string | null } };
